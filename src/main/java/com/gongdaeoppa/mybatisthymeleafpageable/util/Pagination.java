package com.gongdaeoppa.mybatisthymeleafpageable.util;
...
public class Pagination {
    ...
    public Pagination(int currentPage, int cntPerPage, int pageSize) {
        ...
        if (cntPerPage != 5 && cntPerPage != 10 && cntPerPage != 20 && cntPerPage != 30) {
            cntPerPage = 10;
        }
        // 하단 페이지 갯수 10개로 제한
        if (pageSize != 5) {
    ...
    private void calculation() {
        ...
        //220527 by yeseung
        this.setNumber(this.getTotalRecordCount() - this.getFirstRecordIndex());
    }
